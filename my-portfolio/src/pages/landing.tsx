...
const LandingPage: React.FC<LandingProps> = () => {
  ...
  return (
    <div className="flex flex-col">
        <div className='flex flex-row justify-between m-16 gap-4 pt-5 pb-5'>
            <div className="light-blue-bg p-4 rounded-md w-3/5">
            ...
            <div className="puce-bg p-4 rounded-md w-2/5 gap-4">
                <h2 className='text-white text-xl font-bold mb-3'>Other info.</h2>
