  ...
  return(
    <div className="m-4">
      ...
      {techstack.map((item, index) => (
        <p className="max-w-7/10 mr-2 mt-2 text-xs font-semibold badge badge-outline badge-error">{item.title}</p>
      ))}
    </div>
  )
}
...
const CareerPage: React.FC<CareerProps> = () => {
  return (
    <div id="career" className="flex flex-col m-16">
      <div id="job"  className="w-1/2">
        ...
        <div id="internship"  className="w-1/2">
